...
var Reactor = /** @class */ (function (_super) {
    ...
    function Reactor() {
        ...
        global.ship.effects.add('Reactor Max Fuel', _this.prefix + ".max-fuel", 1000);
        global.ship.effects.add('Reactor Max Reserve', _this.prefix + ".max-reserve", 1000);
        global.ship.effects.add('Reactor Efficiency', _this.prefix + ".efficiency", 1.0);
        return _this;
    }
    ...
    Reactor.prototype.tick = function () {
        ...
        if (this.reserve < this.maxReserve) {
            ...
            global.ship.effects.add('Reactor Emissions', 'emit', produceEmit, 1);
